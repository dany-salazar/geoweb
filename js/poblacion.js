...
function addWMS() {
    ...
    map.addSource('wms-incencios', {
      'type': 'raster',
      'tiles': [
        'https://maps.wild-fire.eu/gwis?time=2023-02-04%2F2023-02-06&bbox={bbox-epsg-3857}&format=image/png&service=WMS&version=1.1.1&request=GetMap&srs=EPSG:3857&transparent=true&width=512&height=512&layers=modis.hs'
      ],
      'tileSize': 512
    });
    map.addLayer(
